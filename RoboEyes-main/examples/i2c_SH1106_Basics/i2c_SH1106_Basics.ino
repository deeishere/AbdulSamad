...
#define SCREEN_WIDTH 70 // OLED display width, in pixels
#define SCREEN_HEIGHT 10 // OLED display height, in pixels
...
void setup()   {
  ...
  roboEyes.setWidth(20, 20); // byte leftEye, byte rightEye
  roboEyes.setHeight(20, 20); // byte leftEye, byte rightEye
